...
namespace App\Http\Controllers\SiteSettingManagement;
...
class SiteSettingController extends Controller
{
    public function list()
    {
        ...
        return view('site-setting-management.site-setting.list',$data);
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $store->save();
            DB::commit();
            return response()->json(['status'=>'success','message'=>'Data Successfully Updated','reload_url'=>route('site_setting.list')]);
        } catch (\Exception $e) {
            DB::rollback();
