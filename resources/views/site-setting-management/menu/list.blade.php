                     ...
                     <div class="row">
                         <div class="col-md-12">
                             <div id="nestable" style="width: 100%;">
                                 <?php $parents = App\Models\Menu::with(['module'])
                                         ...
                                         @foreach ($parents as $parent)
                                             <li class="dd-item" data-id="{{ $parent->id }}">
                                                 ...
                                                 <span style="font-size: 20px;z-index:10;position:absolute; right:35px; top:4px; cursor:pointer;">
                                                     <a href="{{ route('menu.edit', $parent->id) }}">
                                                                             ...
                                                                             <li class="dd-item" data-id="{{ $parent->id }}">
                                                                                 ...
                                                                                 @if (count($parents) != 0)
                                                                                     <ol class="dd-list">
                                                                                         @foreach ($parents as $parent)
                                                                                             <li class="dd-item" data-id="{{ $parent->id }}">
                                                                                                 <div class="dd-handle {{ $parent->status == '1' ? 'text-dark' : 'text-danger' }}"> <i class=" text-success {{ $parent->icon }}"></i> | {{ $parent->name }}
                                                                                                 </div>
                                                                                                 <span style="font-size: 20px;z-index:10;position:absolute; right:35px; top:4px; cursor:pointer;">
                                                                                                     <a href="{{ route('menu.edit', $parent->id) }}">
                                                                                                         <i class="fa fa-edit text-primary"></i>
                                                                                                 ...
                                                                                                 @if (count($parents) != 0)
                                                                                                     <ol class="dd-list">
                                                                                                         @foreach ($parents as $parent)
                                                                                                             <li class="dd-item" data-id="{{ $parent->id }}">
                                                                                                                 <div class="dd-handle {{ $parent->status == '1' ? 'text-dark' : 'text-danger' }}"> <i class=" text-success {{ $parent->icon }}"></i> |
                                                                                                                     {{ $parent->name }} </div>
                                                                                                                 <span style="font-size: 20px;z-index:10;position:absolute; right:35px; top:4px; cursor:pointer;">
                                                                                                                     <a href="{{ route('menu.edit', $parent->id) }}">
                                                                                                                         <i class="fa fa-edit text-primary"></i>
