			...
			<div class="col-lg-12">  
				<div class="card">  
					<div class="card-header text-right">  
						...
						<a href="{{route('menu.list')}}" class="btn btn-sm btn-info"><i class="fas fa-list"></i> Menu List</a>  
					</div>  
					<div class="card-body">  
						<form id="submitForm">  
							@csrf  
...
@include('site-setting-management.menu.all-icon-list')   
	...
	$(document).ready(function(){  
		$('#submitForm').validate({  
			...
			submitHandler: function (form) {  
				...
				$.ajax({  
					url : "{{(@$editData)?(route('menu.update',@$editData->id)):route('menu.store')}}",.store')}}",   
					data : formInfo,  
					type : "POST",   
					processData: false,  
					contentType: false,  
